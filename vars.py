...
# API Configuration
API_ID = int(os.environ.get("28262659", ""))
API_HASH = os.environ.get("4fdd8fed9a5609fc0f85aee42da47663", "")
BOT_TOKEN = os.environ.get("7957456180:AAGXvYocwu_PV7SxCxeAx5wuM83zjELX0lw", "")
